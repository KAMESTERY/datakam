...
3. Read your app's source code at src/slapman/service.clj. Explore the docs of functions
   that define routes and responses.
4. Run your app's tests with `lein test`. Read the tests at test/slapman/service_test.clj.
...
2. Build a Docker image: `sudo docker build -t slapman .`
3. Run your Docker image: `docker run -p 8080:8080 slapman`
